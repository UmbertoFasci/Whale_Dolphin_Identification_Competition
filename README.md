...
|Multi-output Branched Models|Writeup of constructing multi-output model architecture with Functional API.| [Repository](https://github.com/UmbertoFasci/Multi-output_Model_wrtup)|
|Compact Convolutional Transformers|Compact convolutional transformers for efficient image classification. [Reference](https://keras.io/examples/vision/cct/)|File in Progress|
